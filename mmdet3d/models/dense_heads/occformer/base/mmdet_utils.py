...
def preprocess_mask_gt(gt_labels, gt_masks, gt_semantic_seg, num_things,
                           num_stuff, img_metas):
    ...
    Returns:
        tuple: a tuple containing the following targets.
            ...
            - masks (Tensor): Ground truth mask for a image, with
                ...
                segmentation, and things only when training
...
def preprocess_instance_occupancy_gt(gt_occ, num_classes, img_metas, max_objects=None):
    """Preprocess the ground truth for a image.
    Args:
